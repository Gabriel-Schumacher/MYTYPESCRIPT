...
</section>`,block:"css-grid",order:6,superOrder:1,superBlock:"responsive-web-design",challengeOrder:20,required:[],template:"",time:"5 hours",helpCategory:"HTML-CSS",translationPending:!1}]}}}},l=d["responsive-web-design"].blocks,s=Object.values(l),c=document.querySelector(".navbar"),i=document.querySelector("#navList"),h=t=>{const n=document.createElement("a");n.classList.add("btn","btn-ghost","normal-case","text-xl","mx-4"),n.textContent=t,n.addEventListener("click",()=>{const e=s.find(o=>o.meta.name===t);console.log(e),p(e)}),c.appendChild(n)};s.forEach(t=>{h(t.meta.name)});const p=t=>{for(;i.firstChild;)i.removeChild(i.firstChild);t.challenges.forEach(n=>{const e=document.createElement("li");e.classList.add("my-4");const o=document.createElement("h3");o.classList.add("w-65","bg-blue-200","rounded","p-2","text-xl","text-center","cursor-pointer","hover:bg-blue-300","hover:text-white","shadow-medium"),o.textContent=n.title,e.addEventListener("click",()=>{m(n)}),e.appendChild(o),i.appendChild(e)})};class u{constructor(n,e,o){this.title=n,this.description=e,this.instructions=o}}const m=t=>{const n=new u(t.title,t.description,t.instructions);console.log(n);const e=document.querySelector("#snippetDisplay");for(;e.firstChild;)e.removeChild(e.firstChild);const o=document.createElement("h2");o.classList.add("text-2xl","font-bold","m-4"),o.textContent=n.title;const a=document.createElement("p");a.classList.add("m-4"),a.innerHTML=n.description;const r=document.createElement("p");r.classList.add("m-4"),r.innerHTML=n.instructions,e.appendChild(o),e.appendChild(a),e.appendChild(r)};
//# sourceMappingURL=classes-a7ca552b.js.map
