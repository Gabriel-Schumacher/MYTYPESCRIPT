...
</section>`,block:"css-grid",order:6,superOrder:1,superBlock:"responsive-web-design",challengeOrder:20,required:[],template:"",time:"5 hours",helpCategory:"HTML-CSS",translationPending:!1}]}}}},s=r["responsive-web-design"].blocks,a=Object.values(s),d=document.querySelector(".navbar"),i=document.querySelector("#navList"),l=t=>{const n=document.createElement("a");n.classList.add("btn","btn-ghost","normal-case","text-xl","mx-4"),n.textContent=t,n.addEventListener("click",()=>{const e=a.find(o=>o.meta.name===t);console.log(e),c(e)}),d.appendChild(n)};a.forEach(t=>{l(t.meta.name)});const c=t=>{for(;i.firstChild;)i.removeChild(i.firstChild);t.challenges.forEach(n=>{const e=document.createElement("li");e.classList.add("my-4");const o=document.createElement("h3");o.classList.add("w-72","bg-blue-200","rounded","p-2","text-xl","text-center","cursor-pointer","hover:bg-blue-300","hover:text-white","shadow-medium"),o.textContent=n.title,e.addEventListener("click",()=>{p(n)}),e.appendChild(o),i.appendChild(e)})};class h{constructor(n,e,o){this.title=n,this.description=e,this.instructions=o}}const p=t=>{const n=new h(t.title,t.description,t.instructions);console.log(n);const e=document.querySelector("#snippetDisplay");for(;e.firstChild;)e.removeChild(e.firstChild);const o=document.createElement("h2");o.classList.add("text-2xl","font-bold","mb-4"),o.textContent=n.title,e.appendChild(o)};
//# sourceMappingURL=classes-8442a6bc.js.map
