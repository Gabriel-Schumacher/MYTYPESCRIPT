var n=Object.defineProperty;var d=(t,e,r)=>e in t?n(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r;var o=(t,e,r)=>(d(t,typeof e!="symbol"?e+"":e,r),r);import"./input-5ca3a6fd.js";const i=[{"Button-title":"Function Parameter Types",title:"Data types can be set on function parameters",explanation:"This is the syntax when indicating the data type of a function parameter. After the parameter name add a colon (:), a space and then the data type you expect. Be sure to use the primitive data types! (e.g. 'number' instead of 'Number')",code:`<pre data-prefix="1"><code>function add(num1; number, num2: number) {</code></pre>
        ...
        <pre data-prefix="3"><code>}</code></pre>`},{"Button-title":"Object Types",title:"Object data type with all properties set",explanation:"TypeScript can infer the data type of an object if all properties are set, but this example shows how to explicitly set the types of each property.",code:`<pre data-prefix="1"><code> enum Role {ADMIN, DEV, STUDENT}</code></pre>
          ...
          <pre data-prefix="21"><code> }</code></pre> `}],c={data:i},s=t=>{t.data.forEach(e=>{console.log(e)})};s(c);class l{constructor(e,r,a){o(this,"title");o(this,"explanation");o(this,"code");this.title=e,this.explanation=r,this.code=a}getTitle(){return this.title}getExplanation(){return this.explanation}getCode(){return this.code}}class x{constructor(e,r,a){this.title=e,this.explanation=r,this.code=a}getTitle(){return this.title}getExplanation(){return this.explanation}getCode(){return this.code}}let p=new l("How to define a class","Here is where I explain how to define class",'<pre data-prefix="1"><code><h1>Hello</h1></code></pre>');console.log(p.getTitle());console.log(p.getExplanation());console.log(Math.random());let f=new x("How to define a simpler shortcut","Here is where I explain how to define a more simple shortcut using the constructor",'<pre data-prefix="1"><code> Class ExampleCodeSnippet</code></pre>');console.log(f.getTitle);
//# sourceMappingURL=classes-91b0b32d.js.map
